async function main() {
    ...
    const fs = `
        ...
        void main() {
            ...
            float spec = pow(max(dot(viewDir, reflectDir), 0.0), 100.0); // Specular highlight

            vec4 diffuse = u_diffuse * v_color;
            vec3 specular = vec3(1.0) * spec; // Specular color putih
    ...
    function render(time) {
        ...
        const sharedUniforms = {
            ...
            u_cameraPosition: [0, 0, radiusWithZoom],
        };
